...
export const ProjectData=[
    ...
    },
    {
        id:1,
        title:"GoMyForum",
        about:"Using React, Node.js, Express & MongoDB, the MERN Application, is called Forum, and it’s a simple web application that allows users to login to be able to post forums and interesting  articles.",
